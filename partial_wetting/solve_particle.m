...
function [m, v, u, du] = solve_particle(l, dx, T, alpha, A0, r0, chi)

% Particle method for GDIM thin film equation with infinite boundary
% condition. (Partial wetting)
%
% Inputs
...
ell = sqrt(w*h_bar);                    % innner product
